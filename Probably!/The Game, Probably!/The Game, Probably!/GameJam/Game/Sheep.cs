...
namespace XnaAsignGame
{
    ...
    {        
        ...
        public Texture2D texExp { get; set; } //is used for the texture
        ...
        float intervalTimer = 60f;
        bool aniOn = false;
        public bool expOn = false;
        public int currentFrame = 1; 

        public Sheep(Texture2D texture, Vector2 texSize, Vector2 texPos, int mainSpeed)//constructuor intitiases everything here
        {
            tex = texture;
            size = texSize;
            pos = texPos;
